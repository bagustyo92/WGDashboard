 ...
 * {@link NetProfitList5Fragment.OnNetProfitList5FragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link NetProfitList5Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NetProfitList5Fragment extends Fragment {
    ...
    private OnNetProfitList5FragmentInteractionListener mListener;

    DecimalFormat decimalFormat = new DecimalFormat("#,###,##0.00");

    private ArrayList<NetProfit> netProfitList = new ArrayList<>();

    public NetProfitList5Fragment() {
    ...
    public static NetProfitList5Fragment newInstance(String param1, String param2) {
        NetProfitList5Fragment fragment = new NetProfitList5Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_net_profit_list5, container, false);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onNetProfitList5FragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnNetProfitList5FragmentInteractionListener) {
            mListener = (OnNetProfitList5FragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnNetProfitList5FragmentInteractionListener {
        // TODO: Update argument type and name
        void onNetProfitList5FragmentInteraction(Uri uri);
    }
    ...
    public void loadData(JSONObject jsonData) {
        ...
        try {
            setNetProfitValue(1, "totalLabaKotorStlhPphFinal", "total", jsonData);
            setNetProfitValue(6, "totalLabaKotorStlhPphFinal", "nonJoIntegratedEkstern", jsonData);
            setNetProfitValue(11, "totalLabaKotorStlhPphFinal", "joKso", jsonData);

            setNetProfitValue(17, "labaKotorStlhPphFinalLama", "lama", jsonData);
            setNetProfitValue(22, "labaKotorStlhPphFinalLama", "eksternIntern", jsonData);
            setNetProfitValue(27, "labaKotorStlhPphFinalLama", "joKso", jsonData);

            setNetProfitValue(33, "labaKotorStlhPphFinalBaru", "lama", jsonData);
            setNetProfitValue(38, "labaKotorStlhPphFinalBaru", "eksternIntern", jsonData);
            setNetProfitValue(43, "labaKotorStlhPphFinalBaru", "joKso", jsonData);

            setNetProfitValue(49, "efisiensiInefisiensilabaKotorStlhPphFinal", "efisiensiInefisiensi", jsonData);
            setNetProfitValue(54, "efisiensiInefisiensilabaKotorStlhPphFinal", "biayaStandar", jsonData);
            setNetProfitValue(59, "efisiensiInefisiensilabaKotorStlhPphFinal", "realisasiBiaya", jsonData);
    ...
    public class NetProfitAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public int getItemViewType(int position) {
            ...
            if(NetProfitList5Fragment.this.netProfitList.size() > 0){
                return NetProfitList5Fragment.this.netProfitList.get(position).getRowType();
            }else{
                return 0;
            }
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if(NetProfitList5Fragment.this.netProfitList.size() > 0){
                int rowType = NetProfitList5Fragment.this.netProfitList.get(position).getRowType();
                if(rowType == 0){
    ...
    private void initNetProfitList(){
        ...
        addToNetProfitList("Non JO Integrated, Ekstern");
        ...
        addToNetProfitList("JO/KSO");
        addSeparator();
        addToNetProfitList("Efisiensi / Inefisiensi");
        addToNetProfitList("Biaya Standar");
        addToNetProfitList("Realisasi Biaya");
