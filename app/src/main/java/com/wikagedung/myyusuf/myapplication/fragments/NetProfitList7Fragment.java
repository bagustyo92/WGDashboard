 ...
 * {@link NetProfitList7Fragment.OnNetProfitList7FragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link NetProfitList7Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NetProfitList7Fragment extends Fragment {
    ...
    private OnNetProfitList7FragmentInteractionListener mListener;

    DecimalFormat decimalFormat = new DecimalFormat("#,###,##0.00");

    private ArrayList<NetProfit> netProfitList = new ArrayList<>();

    public NetProfitList7Fragment() {
    ...
    public static NetProfitList7Fragment newInstance(String param1, String param2) {
        NetProfitList7Fragment fragment = new NetProfitList7Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_net_profit_list7, container, false);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onNetProfitList7FragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnNetProfitList7FragmentInteractionListener) {
            mListener = (OnNetProfitList7FragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnNetProfitList7FragmentInteractionListener {
        // TODO: Update argument type and name
        void onNetProfitList7FragmentInteraction(Uri uri);
    }
    ...
    public void loadData(JSONObject jsonData) {
        ...
        try {
            setNetProfitValue(1, "labaUsaha", "labaUsaha", jsonData);

            setNetProfitValue(7, "labaUsahaLspLabaRugiLain", "labaRugiLain", jsonData);
            setNetProfitValue(12, "labaUsahaLspLabaRugiLain", "bunga", jsonData);
            setNetProfitValue(17, "labaUsahaLspLabaRugiLain", "labaRugiPenjualanAktivaTetap", jsonData);
            setNetProfitValue(22, "labaUsahaLspLabaRugiLain", "lainLain", jsonData);

            setNetProfitValue(28, "labaSebelumPajak", "labaSebelumPajak", jsonData);
    ...
    public class NetProfitAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public int getItemViewType(int position) {
            ...
            if(NetProfitList7Fragment.this.netProfitList.size() > 0){
                return NetProfitList7Fragment.this.netProfitList.get(position).getRowType();
            }else{
                return 0;
            }
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if(NetProfitList7Fragment.this.netProfitList.size() > 0){
                int rowType = NetProfitList7Fragment.this.netProfitList.get(position).getRowType();
                if(rowType == 0){
    ...
    private void initNetProfitList(){
        ...
        addToNetProfitList("Laba Usaha");
        addSeparator();
        addToNetProfitList("Laba / Rugi Lain-lain");
        addToNetProfitList("Bunga");
        addToNetProfitList("L/R Penjualan Aktiva Tetap");
        addToNetProfitList("Lain-lain (Jasa Giro, Selisih Kurs, dll)");
        addSeparator();
        addToNetProfitList("Laba Sebelum Pajak");
