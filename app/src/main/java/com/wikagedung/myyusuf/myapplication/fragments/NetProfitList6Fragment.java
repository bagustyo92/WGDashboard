 ...
 * {@link NetProfitList6Fragment.OnNetProfitList6FragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link NetProfitList6Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NetProfitList6Fragment extends Fragment {
    ...
    private OnNetProfitList6FragmentInteractionListener mListener;

    DecimalFormat decimalFormat = new DecimalFormat("#,###,##0.00");

    private ArrayList<NetProfit> netProfitList = new ArrayList<>();

    public NetProfitList6Fragment() {
    ...
    public static NetProfitList6Fragment newInstance(String param1, String param2) {
        NetProfitList6Fragment fragment = new NetProfitList6Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_net_profit_list6, container, false);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onNetProfitList6FragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnNetProfitList6FragmentInteractionListener) {
            mListener = (OnNetProfitList6FragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnNetProfitList6FragmentInteractionListener {
        // TODO: Update argument type and name
        void onNetProfitList6FragmentInteraction(Uri uri);
    }
    ...
    public void loadData(JSONObject jsonData) {
        ...
        try {
            setNetProfitValue(1, "biayaUsaha", "biayaUsaha", jsonData);
            setNetProfitValue(6, "biayaUsaha", "biayaUsahaDepartemen", jsonData);
            setNetProfitValue(11, "biayaUsaha", "kompensasiBiayaUsaha", jsonData);
    ...
    public class NetProfitAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public int getItemViewType(int position) {
            ...
            if(NetProfitList6Fragment.this.netProfitList.size() > 0){
                return NetProfitList6Fragment.this.netProfitList.get(position).getRowType();
            }else{
                return 0;
            }
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if(NetProfitList6Fragment.this.netProfitList.size() > 0){
                int rowType = NetProfitList6Fragment.this.netProfitList.get(position).getRowType();
                if(rowType == 0){
    ...
    private void initNetProfitList(){
        ...
        addToNetProfitList("Biaya Usaha");
        addToNetProfitList("Biaya Usaha Dept / PA");
        addToNetProfitList("Kompensasi Biaya Usaha (+/-)");
