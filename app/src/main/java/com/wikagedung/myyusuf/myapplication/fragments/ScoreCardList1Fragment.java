 ...
 * {@link ScoreCardList1Fragment.OnScoreCardList1FragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ScoreCardList1Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ScoreCardList1Fragment extends Fragment {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    private static final String TAG = "ScoreCardList1Fragment";
    ...
    private OnScoreCardList1FragmentInteractionListener mListener;

    DecimalFormat decimalFormat = new DecimalFormat("#,###,###");

    private ArrayList<ScoreCard> scoreCardList = new ArrayList<>();

    public ScoreCardList1Fragment() {
     ...
     * @return A new instance of fragment ScoreCardList1Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ScoreCardList1Fragment newInstance(String param1, String param2) {
        ScoreCardList1Fragment fragment = new ScoreCardList1Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_score_card_list1, container, false);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onScoreCardList1FragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnScoreCardList1FragmentInteractionListener) {
            mListener = (OnScoreCardList1FragmentInteractionListener) context;
        } else {
    ...
    public void loadData(JSONObject jsonData) {
        ...
        try {
            setScoreCardValue(1, "kinerjaProdukProses", "inovasi", jsonData);
            setScoreCardValue(3, "kinerjaProdukProses", "qsheExcel", jsonData);
            setScoreCardValue(5, "kinerjaProdukProses", "competitiveIndex", jsonData);
     ...
     */
    public interface OnScoreCardList1FragmentInteractionListener {
        // TODO: Update argument type and name
        void onScoreCardList1FragmentInteraction(Uri uri);
    }
    ...
    public class ScoreCardAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public int getItemViewType(int position) {
            ...
            if(ScoreCardList1Fragment.this.scoreCardList.size() > 0){
                return ScoreCardList1Fragment.this.scoreCardList.get(position).getRowType();
            }else{
                return 0;
            }
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if(ScoreCardList1Fragment.this.scoreCardList.size() > 0){
                int rowType = ScoreCardList1Fragment.this.scoreCardList.get(position).getRowType();
                if(rowType == 0){
    ...
    private void initScoreCardList(){
        ...
        addToScoreCardList("Inovasi");
        addToScoreCardList("QHSE Level Index");
        addToScoreCardList("Competitive Index (%)");
