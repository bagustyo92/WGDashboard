 ...
 * {@link NetProfitList3Fragment.OnNetProfitList3FragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link NetProfitList3Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NetProfitList3Fragment extends Fragment {
    ...
    private OnNetProfitList3FragmentInteractionListener mListener;

    DecimalFormat decimalFormat = new DecimalFormat("#,###,##0.00");

    private ArrayList<NetProfit> netProfitList = new ArrayList<>();

    public NetProfitList3Fragment() {
    ...
    public static NetProfitList3Fragment newInstance(String param1, String param2) {
        NetProfitList3Fragment fragment = new NetProfitList3Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_net_profit_list3, container, false);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onNetProfitList3FragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnNetProfitList3FragmentInteractionListener) {
            mListener = (OnNetProfitList3FragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnNetProfitList3FragmentInteractionListener {
        // TODO: Update argument type and name
        void onNetProfitList3FragmentInteraction(Uri uri);
    }
    ...
    public void loadData(JSONObject jsonData) {
        ...
        try {
            setNetProfitValue(1, "totalLabaKotor", "total", jsonData);
            setNetProfitValue(6, "totalLabaKotor", "ekstern", jsonData);
            setNetProfitValue(11, "totalLabaKotor", "joKso", jsonData);

            setNetProfitValue(17, "labaKotorLama", "lama", jsonData);
            setNetProfitValue(22, "labaKotorLama", "eksternIntern", jsonData);
            setNetProfitValue(27, "labaKotorLama", "joKso", jsonData);

            setNetProfitValue(33, "labaKotorBaru", "baru", jsonData);
            setNetProfitValue(38, "labaKotorBaru", "eksternIntern", jsonData);
            setNetProfitValue(43, "labaKotorBaru", "joKso", jsonData);
    ...
    public class NetProfitAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public int getItemViewType(int position) {
            ...
            if(NetProfitList3Fragment.this.netProfitList.size() > 0){
                return NetProfitList3Fragment.this.netProfitList.get(position).getRowType();
            }else{
                return 0;
            }
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if(NetProfitList3Fragment.this.netProfitList.size() > 0){
                int rowType = NetProfitList3Fragment.this.netProfitList.get(position).getRowType();
                if(rowType == 0){
