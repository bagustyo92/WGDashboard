 ...
 * {@link ScoreCardList3Fragment.OnScoreCardList3FragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ScoreCardList3Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ScoreCardList3Fragment extends Fragment {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    private static final String TAG = "ScoreCardList3Fragment";
    ...
    private OnScoreCardList3FragmentInteractionListener mListener;

    DecimalFormat decimalFormat = new DecimalFormat("#,###,###");

    private ArrayList<ScoreCard> scoreCardList = new ArrayList<>();

    public ScoreCardList3Fragment() {
     ...
     * @return A new instance of fragment ScoreCardList3Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ScoreCardList3Fragment newInstance(String param1, String param2) {
        ScoreCardList3Fragment fragment = new ScoreCardList3Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_score_card_list3, container, false);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onScoreCardList3FragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnScoreCardList3FragmentInteractionListener) {
            mListener = (OnScoreCardList3FragmentInteractionListener) context;
        } else {
    ...
    public void loadData(JSONObject jsonData) {
        ...
        try {
            setScoreCardValue(1, "kinerjaKeuanganPasar", "netProfit", jsonData);
            setScoreCardValue(3, "kinerjaKeuanganPasar", "arusKasOperasi", jsonData);
            setScoreCardValue(5, "kinerjaKeuanganPasar", "okBaru", jsonData);
            setScoreCardValue(7, "kinerjaKeuanganPasar", "penjualanThdKontrakDihadapi", jsonData);
     ...
     */
    public interface OnScoreCardList3FragmentInteractionListener {
        // TODO: Update argument type and name
        void onScoreCardList3FragmentInteraction(Uri uri);
    }
    ...
    public class ScoreCardAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public int getItemViewType(int position) {
            ...
            if(ScoreCardList3Fragment.this.scoreCardList.size() > 0){
                return ScoreCardList3Fragment.this.scoreCardList.get(position).getRowType();
            }else{
                return 0;
            }
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if(ScoreCardList3Fragment.this.scoreCardList.size() > 0){
                int rowType = ScoreCardList3Fragment.this.scoreCardList.get(position).getRowType();
                if(rowType == 0){
    ...
    private void initScoreCardList(){
        ...
        addToScoreCardList("Net Profit");
        addToScoreCardList("Arus Kas Operasi");
        addToScoreCardList("OK Baru");
        addToScoreCardList("Penjualan Kontrak Dihadapi");
