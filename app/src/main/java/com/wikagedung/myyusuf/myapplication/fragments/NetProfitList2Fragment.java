 ...
 * {@link NetProfitList2Fragment.OnNetProfitList2FragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link NetProfitList2Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NetProfitList2Fragment extends Fragment {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    private static final String TAG = "NetProfitList2Fragment";
    ...
    private OnNetProfitList2FragmentInteractionListener mListener;

    DecimalFormat decimalFormat = new DecimalFormat("#,###,##0.00");

    private ArrayList<NetProfit> netProfitList = new ArrayList<>();

    public NetProfitList2Fragment() {
     ...
     * @return A new instance of fragment NetProfitList2Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static NetProfitList2Fragment newInstance(String param1, String param2) {
        NetProfitList2Fragment fragment = new NetProfitList2Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_net_profit_list2, container, false);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onNetProfitList2FragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnNetProfitList2FragmentInteractionListener) {
            mListener = (OnNetProfitList2FragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnNetProfitList2FragmentInteractionListener {
        // TODO: Update argument type and name
        void onNetProfitList2FragmentInteraction(Uri uri);
    }
    ...
    public void loadData(JSONObject jsonData) {
        ...
        try {
            setNetProfitValue(1, "totalPenjualan", "total", jsonData);
            setNetProfitValue(6, "totalPenjualan", "ekstern", jsonData);
            setNetProfitValue(11, "totalPenjualan", "joKso", jsonData);
            setNetProfitValue(16, "totalPenjualan", "intern", jsonData);

            setNetProfitValue(22, "penjualanLama", "lama", jsonData);
            setNetProfitValue(27, "penjualanLama", "ekstern", jsonData);
            setNetProfitValue(32, "penjualanLama", "joKso", jsonData);
            setNetProfitValue(37, "penjualanLama", "intern", jsonData);

            setNetProfitValue(43, "penjualanBaru", "baru", jsonData);
            setNetProfitValue(48, "penjualanBaru", "ekstern", jsonData);
            setNetProfitValue(53, "penjualanBaru", "joKso", jsonData);
            setNetProfitValue(58, "penjualanBaru", "intern", jsonData);
    ...
    public class NetProfitAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public int getItemViewType(int position) {
            ...
            if(NetProfitList2Fragment.this.netProfitList.size() > 0){
                return NetProfitList2Fragment.this.netProfitList.get(position).getRowType();
            }else{
                return 0;
            }
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if(NetProfitList2Fragment.this.netProfitList.size() > 0){
                int rowType = NetProfitList2Fragment.this.netProfitList.get(position).getRowType();
                if(rowType == 0){
