 ...
 * {@link ScoreCardList4Fragment.OnScoreCardList4FragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ScoreCardList4Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ScoreCardList4Fragment extends Fragment {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    private static final String TAG = "ScoreCardList4Fragment";
    ...
    private OnScoreCardList4FragmentInteractionListener mListener;

    DecimalFormat decimalFormat = new DecimalFormat("#,###,###");

    private ArrayList<ScoreCard> scoreCardList = new ArrayList<>();

    public ScoreCardList4Fragment() {
     ...
     * @return A new instance of fragment ScoreCardList4Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ScoreCardList4Fragment newInstance(String param1, String param2) {
        ScoreCardList4Fragment fragment = new ScoreCardList4Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_score_card_list4, container, false);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onScoreCardList4FragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnScoreCardList4FragmentInteractionListener) {
            mListener = (OnScoreCardList4FragmentInteractionListener) context;
        } else {
    ...
    public void loadData(JSONObject jsonData) {
        ...
        try {
            setScoreCardValue(1, "kinerjaFokusTenagaKerja", "hcEngagementLevel", jsonData);
     ...
     */
    public interface OnScoreCardList4FragmentInteractionListener {
        // TODO: Update argument type and name
        void onScoreCardList4FragmentInteraction(Uri uri);
    }
    ...
    public class ScoreCardAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public int getItemViewType(int position) {
            ...
            if(ScoreCardList4Fragment.this.scoreCardList.size() > 0){
                return ScoreCardList4Fragment.this.scoreCardList.get(position).getRowType();
            }else{
                return 0;
            }
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if(ScoreCardList4Fragment.this.scoreCardList.size() > 0){
                int rowType = ScoreCardList4Fragment.this.scoreCardList.get(position).getRowType();
                if(rowType == 0){
