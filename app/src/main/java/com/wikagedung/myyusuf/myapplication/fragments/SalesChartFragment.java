 ...
 * {@link SalesChartFragment.OnSalesChartFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SalesChartFragment#newInstance} factory method to
...
public class SalesChartFragment extends Fragment {
     ...
     * @return A new instance of fragment SalesChartFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SalesChartFragment newInstance(String param1, String param2, Integer param3, Integer param4) {
        SalesChartFragment fragment = new SalesChartFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_sales_chart, container, false);
        ...
        mChart = (LineChart)view.findViewById(R.id.sales_chart);
        salesChartCaption = (TextView) view.findViewById(R.id.sales_chart_caption);
        detailButton = (Button) view.findViewById(R.id.sales_chart_button);
        detailButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SalesChartFragment.this.mListener.onSalesChartDetailButtonPressed();
            }
        });
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onSalesChartFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnSalesChartFragmentInteractionListener) {
            mListener = (OnSalesChartFragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnSalesChartFragmentInteractionListener {
        // TODO: Update argument type and name
        void onSalesChartFragmentInteraction(Uri uri);

        void onSalesChartDetailButtonPressed();
    }
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    ...
                    try {
                        ...
                        if(!obj.get("penjualanRa").toString().equals("null")){
                            planDataEntries.add(new Entry(i + 1, new Float(obj.getDouble("penjualanRa"))));
                        }

                        if(!obj.get("penjualanRi").toString().equals("null")){
                            actualDataEntries.add(new Entry(i + 1, new Float(obj.getDouble("penjualanRi"))));
                        }
...
//                Log.v("KAT", "MyAuth: authenticating");
                ...
                String encodedString = Base64.encodeToString(String.format("%s:%s", SalesChartFragment.this.mParam1, SalesChartFragment.this.mParam2).getBytes(), Base64.NO_WRAP);
...
//                Map<String, String> map = new HashMap<String, String>();
//                String key = "Authorization";
//                String encodedString = Base64.encodeToString(String.format("%s:%s", "tester", "Xqnd43W11").getBytes(), Base64.NO_WRAP);
//                String value = String.format("Basic %s", encodedString);
//                map.put(key, value);
//
//                return map;
...
//                (Request.Method.GET, baseURL, new Response.Listener<String>() {
//
//                    @Override
    ...
    private void drawChart(List<Entry> planDataEntries, List<Entry> actualDataEntries){
        ...
        AxisValueFormatter formatter = new AxisValueFormatter() {
            ...
            public String getFormattedValue(float value, AxisBase axis) {
                ...
                if(valueInInt >= 0 && valueInInt < SalesChartFragment.this.MONTHS.length){
                    return SalesChartFragment.this.MONTHS[(int) value];
                }else{
                    return "";
                }
            }
...
//            mChart.centerViewToAnimated(xValue, yValue, YAxis.AxisDependency.LEFT, 1);
    ...
    private void updateSelectedMonth(int value){
        if(value + 1 < this.actualDataEntries.size()){
            salesChartCaption.setText(this.decimalFormat.format(this.actualDataEntries.get(value + 1).getY()));
        }else{
            salesChartCaption.setText("0.00");
        }
