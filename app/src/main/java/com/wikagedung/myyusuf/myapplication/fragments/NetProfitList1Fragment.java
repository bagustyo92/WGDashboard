 ...
 * {@link NetProfitList1Fragment.OnNetProfitList1FragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link NetProfitList1Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NetProfitList1Fragment extends Fragment {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    private static final String TAG = "NetProfitList1Fragment";
    ...
    private OnNetProfitList1FragmentInteractionListener mListener;

    DecimalFormat decimalFormat = new DecimalFormat("#,###,##0.00");

    private ArrayList<NetProfit> netProfitList = new ArrayList<>();

    public NetProfitList1Fragment() {
     ...
     * @return A new instance of fragment NetProfitList1Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static NetProfitList1Fragment newInstance(String param1, String param2) {
        NetProfitList1Fragment fragment = new NetProfitList1Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_net_profit_list1, container, false);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onNetProfitList1FragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnNetProfitList1FragmentInteractionListener) {
            mListener = (OnNetProfitList1FragmentInteractionListener) context;
        } else {
    ...
    public void loadData(JSONObject jsonData) {
        ...
        try {
            setNetProfitValue(1, "totalKontrakDihadapi", "total", jsonData);
            setNetProfitValue(6, "totalKontrakDihadapi", "ekstern", jsonData);
            setNetProfitValue(11, "totalKontrakDihadapi", "joKso", jsonData);
            setNetProfitValue(16, "totalKontrakDihadapi", "intern", jsonData);

            setNetProfitValue(22, "sisaKontrakDihadapi", "sisaKontrakPesananTahunLalu", jsonData);
            setNetProfitValue(27, "sisaKontrakDihadapi", "ekstern", jsonData);
            setNetProfitValue(32, "sisaKontrakDihadapi", "joKso", jsonData);
            setNetProfitValue(37, "sisaKontrakDihadapi", "intern", jsonData);

            setNetProfitValue(43, "pesananBaruKontrakDihadapi", "kontrakPesananBaru", jsonData);
            setNetProfitValue(48, "pesananBaruKontrakDihadapi", "ekstern", jsonData);
            setNetProfitValue(53, "pesananBaruKontrakDihadapi", "joKso", jsonData);
            setNetProfitValue(58, "pesananBaruKontrakDihadapi", "intern", jsonData);
     ...
     */
    public interface OnNetProfitList1FragmentInteractionListener {
        // TODO: Update argument type and name
        void onNetProfitList1FragmentInteraction(Uri uri);
    }
    ...
    public class NetProfitAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public int getItemViewType(int position) {
            ...
            if(NetProfitList1Fragment.this.netProfitList.size() > 0){
                return NetProfitList1Fragment.this.netProfitList.get(position).getRowType();
            }else{
                return 0;
            }
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if(NetProfitList1Fragment.this.netProfitList.size() > 0){
                int rowType = NetProfitList1Fragment.this.netProfitList.get(position).getRowType();
                if(rowType == 0){
    ...
    private void initNetProfitList(){
        ...
        addToNetProfitList("Intern");
        addSeparator();
        addToNetProfitList("Sisa Kontrak / Pesanan Tahun Lalu");
        addToNetProfitList("Ekstern");
        addToNetProfitList("JO/KSO");
        addToNetProfitList("Intern");
        addSeparator();
        addToNetProfitList("Kontrak / Pesanan Baru");
        addToNetProfitList("Ekstern");
        addToNetProfitList("JO/KSO");
        addToNetProfitList("Intern");
