 ...
 * {@link ScoreCardList5Fragment.OnScoreCardList5FragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ScoreCardList5Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ScoreCardList5Fragment extends Fragment {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    private static final String TAG = "ScoreCardList5Fragment";
    ...
    private OnScoreCardList5FragmentInteractionListener mListener;

    DecimalFormat decimalFormat = new DecimalFormat("#,###,###");

    private ArrayList<ScoreCard> scoreCardList = new ArrayList<>();

    public ScoreCardList5Fragment() {
     ...
     * @return A new instance of fragment ScoreCardList5Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ScoreCardList5Fragment newInstance(String param1, String param2) {
        ScoreCardList5Fragment fragment = new ScoreCardList5Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_score_card_list5, container, false);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onScoreCardList5FragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnScoreCardList5FragmentInteractionListener) {
            mListener = (OnScoreCardList5FragmentInteractionListener) context;
        } else {
    ...
    public void loadData(JSONObject jsonData) {
        ...
        try {
            setScoreCardValue(1, "kinerjaKepemimpinanTataKelola", "gcgLevel", jsonData);
            setScoreCardValue(3, "kinerjaKepemimpinanTataKelola", "riskMaturityLevel", jsonData);
     ...
     */
    public interface OnScoreCardList5FragmentInteractionListener {
        // TODO: Update argument type and name
        void onScoreCardList5FragmentInteraction(Uri uri);
    }
    ...
    public class ScoreCardAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public int getItemViewType(int position) {
            ...
            if(ScoreCardList5Fragment.this.scoreCardList.size() > 0){
                return ScoreCardList5Fragment.this.scoreCardList.get(position).getRowType();
            }else{
                return 0;
            }
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if(ScoreCardList5Fragment.this.scoreCardList.size() > 0){
                int rowType = ScoreCardList5Fragment.this.scoreCardList.get(position).getRowType();
                if(rowType == 0){
    ...
    private void initScoreCardList(){
        ...
        addToScoreCardList("GCG Level");
        addToScoreCardList("Risk Maturity Level");
